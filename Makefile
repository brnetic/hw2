...
OBJS = amazon.o mydatastore.o user.o db_parser.o product.o book.o movie.o clothing.o product_parser.o util.o 
...
mydatastore.o: mydatastore.cpp mydatastore.h product.h user.h product.h util.h datastore.h
